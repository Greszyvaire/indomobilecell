app.controller('appcustomerCtrl', function ($scope, Data, toaster) {
    //upload
    ...
    $scope.callServer = function callServer(tableState) {
        ...
        Data.get('appcustomer/index', param).then(function (data) {
    ...
    $scope.delete = function (row) {
        if (confirm("Apa anda yakin akan MENGHAPUS PERMANENT item ini ?")) {
            Data.delete('appcustomer/delete/' + row.id).then(function (result) {
