                            ...
                            <li class="yamm-content">
                                <div class="row">
                                    ...
                                    <div class="dropdown-banner-holder">
                                        <a href="#"><img alt="" src="http://www.indomobilecell.com/app/img/banners/accesories.png" /></a>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul class="dropdown-menu mega-menu">
                            <li class="yamm-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="dropdown-banner-holder">
                                        <a href="#"><img alt="" src="http://www.indomobilecell.com/app/img/banners/smartphone.png" /></a>
                                    </div>
                                </div>
                                <!-- ================================== MEGAMENU VERTICAL ================================== -->                        
                            </li>
                        ...
                        <ul class="dropdown-menu mega-menu">
                            <li class="yamm-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="dropdown-banner-holder">
                                        <a href="#"><img alt="" src="http://www.indomobilecell.com/app/img/banners/tablet.png" /></a>
                                    </div>
                                </div>
                        ...
                        <ul class="dropdown-menu mega-menu">
                            <li class="yamm-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="dropdown-banner-holder">
                                        <a href="#"><img alt="" src="http://www.indomobilecell.com/app/img/banners/handphone.png" /></a>
                                    </div>
                                </div>
                                <!-- ================================== MEGAMENU VERTICAL ================================== -->    
                            </li>
    ...
    <div class="col-xs-12 col-sm-8 col-md-9 homebanner-holder hidden-xs">
        ...
        <div id="hero">
            <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                ...
                <div class="item" style="background-image: url(http://indomobilecell.com/app/img/file/slider/slider1.jpg);  background-size: 876px 325px;">
                </div><!-- /.item -->
                <div class="item" style="background-image: url(http://indomobilecell.com/app/img/file/slider/slider2.jpg); background-size: 876px 325px;">
                </div><!-- /.item -->
                <div class="item" style="background-image: url(http://indomobilecell.com/app/img/file/slider/slider3.jpg); background-size: 876px 325px;">
                </div><!-- /.item -->
...
<section id="banner-holder" class="wow fadeInUp">
    <div class="container">
        <div class="col-xs-12 col-lg-6 no-margin banner">
                ...
                <img class="banner-image" alt="" src="images/blank.gif" data-echo="http://indomobilecell.com/app/img/file/banner1.png" />
            
        </div>
        <div class="col-xs-12 col-lg-6 no-margin text-right banner">
            
              
                <img class="banner-image" alt="" src="images/blank.gif" data-echo="http://indomobilecell.com/app/img/file/banner2.png" />
